...
if(isset($_POST['update_element']) && isset($_POST['update_element_name']) && isset($_POST['update_element_id'])){
    $response = array();
    $mysql->connect();
    $result = $mysql->updateElement($_POST['update_element'], $_POST['update_element_id'], $_POST['update_element_name']);
    if($result === true){
...
elseif(isset($_POST['update_element_detail']) && isset($_POST['update_element_detail_id']) && isset($_POST['update_element_detail_name']) && isset($_POST['update_element_detail_value'])){
    $response = array();
    $mysql->connect();
    $result = $mysql->updateElementDetail($_POST['update_element_detail'], $_POST['update_element_detail_id'], $_POST['update_element_detail_name'], $_POST['update_element_detail_value']);
    if($result === true){
        $response['response_value'] = 1;
